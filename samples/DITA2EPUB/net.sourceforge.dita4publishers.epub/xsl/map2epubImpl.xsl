...
<!--  <xsl:include href="map2epubIndexImpl.xsl"/>-->
 ...
 <!-- The path of the directory, relative the $outdir parameter,
  ...
  <xsl:template name="getString">
    <xsl:param name="stringName" select="''"/>
  ...
  <xsl:template name="replace-extension"></xsl:template>
  
  <xsl:template name="length-to-pixels"></xsl:template>
  
  <xsl:param name="DEFAULTLANG"></xsl:param>
